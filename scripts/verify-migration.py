"""Verify an actual schema-2/3/4/5/6 project on a new copy, preserving its source tree."""
...
def main() -> None:
    ...
    assert before["schema"] in {2, 3, 4, 5, 6} and before["datasets"], "Supply an existing schema-2/3/4/5/6 project with data."
