...
- [x] 50 万流式导入、独立查询进程、自动资源监控、优先级请求调度及取消（源码及原生调试实测，最终冻结待验收）。
- [x] 分析记录/输入版本追溯、schema 1–5 迁移、另存/移动/重开与发布恢复。
- [ ] 1000/10000/100000/250000/500000 合成压力测试及复杂/超预算失败保护。
- [ ] 完整回归、源码/冻结/原生响应性测量、NSIS/安装后验收。
- [ ] Git 提交/推送、准确 SHA 的 Windows CI、阶段总结与精简交接。

以上 Phase 2 验证尚未完成，不引用 Phase 1D 的通过结果代替。
