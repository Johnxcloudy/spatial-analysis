...
状态：方案已获批准，Phase 0 已完成本机交付；用户已授权推进 Phase 1A，并选择合成样本验收。本文件保留开发前评估，当前实施约束见 phase-1a.md，Phase 0 的实际证据见 verification.md。
...
| 后续版本 | 按需求加入其他矢量工具、栅格、制图、专题指标、路网和 AI | 每次新增一条可验收工作流程，复用已稳定的模型和工具 |
...
Phase 2 形成内部可试用版本，Phase 3 才作为首个稳定交付节点。专业 PDF 布局和自动更新可后置；首版至少保证手动升级不破坏已有项目。
