...
import { pageFailureText } from '../page-query-error';

export function AttributeTable({ dataset, page, loading, error, onRetry, query, setQuery, selectedId, selected, selectedSourceRow, onSelect, onClear, enabled }: {
